...
// Enhanced User-Friendly Interpretation Interface
interface EnhancedInterpretation {
  ...
  // NEW: User-friendly explanations (assumes users know NOTHING about astrology)
  whatThisIs?: string;              // Simple definition in plain language
  whatThisMeansForYou?: string;     // Personal impact explanation
  howThisShowsUp?: string[];        // Real-life examples (3-5 concrete scenarios)
  whyThisMatters?: string;          // Context and reasoning
  whatToWatchFor?: string;          // Balance and challenges (optional)
  birthDataConnection?: string;     // Connection to birth moment
}

// Planet meanings in user-friendly language
const PLANET_MEANINGS_USER_FRIENDLY: Record<string, {
  name: string;
  whatItIs: string;
  governs: string;
  ...
  sun: {
    name: "Your Sun",
    whatItIs: "Your Sun (your core identity and life purpose)",
    governs: "your core identity, ego, and life purpose",
    personalImpact: "who you are at your deepest core",
    whyItMatters: "The Sun represents your soul's essence - it's the most important part of your chart because it shows your fundamental nature.",
    lifeArea: "identity and purpose"
  },
  moon: {
    name: "Your Moon",
    whatItIs: "Your Moon (your emotional nature and inner world)",
    governs: "your emotions, intuition, and emotional responses",
    personalImpact: "how you feel and process emotions",
    whyItMatters: "The Moon represents your emotional nature - it shows how you feel, what makes you feel secure, and how you nurture yourself and others.",
    lifeArea: "emotions and inner world"
  },
  mercury: {
    name: "Mercury",
    whatItIs: "Mercury (how you think and communicate)",
    governs: "your thinking, communication, and learning style",
    personalImpact: "how you think, learn, and communicate",
    whyItMatters: "Mercury rules communication and thinking - it shows how you process information and share your thoughts with others.",
    lifeArea: "communication and thinking"
  },
  venus: {
    name: "Venus",
    whatItIs: "Venus (love, beauty, and what you value)",
    governs: "love, beauty, values, and relationships",
    personalImpact: "how you love, what you find beautiful, and what you value",
    whyItMatters: "Venus rules love and beauty - it shows what you're attracted to, how you express love, and what brings you pleasure.",
    lifeArea: "love and values"
  },
  mars: {
    name: "Mars",
    whatItIs: "Mars (your drive, action, and passion)",
    governs: "action, drive, passion, and how you assert yourself",
    personalImpact: "how you take action and what drives you",
    whyItMatters: "Mars rules action and drive - it shows how you pursue your goals and express your passion and assertiveness.",
    lifeArea: "action and drive"
  },
  jupiter: {
    name: "Jupiter",
    whatItIs: "Jupiter (expansion, wisdom, and growth)",
    governs: "expansion, wisdom, growth, and abundance",
    personalImpact: "where you grow, expand, and find wisdom",
    whyItMatters: "Jupiter is called 'The Great Benefic' because it brings expansion and growth - it shows where you find abundance and wisdom in your life.",
    lifeArea: "growth and wisdom"
  },
  saturn: {
    name: "Saturn",
    whatItIs: "Saturn (structure, discipline, and lessons)",
    governs: "structure, discipline, responsibility, and life lessons",
    personalImpact: "where you learn life's most important lessons",
    whyItMatters: "Saturn is called 'The Teacher' because it shows where you face challenges that help you grow stronger and wiser.",
    lifeArea: "lessons and responsibility"
  },
  uranus: {
    name: "Uranus",
    whatItIs: "Uranus (innovation, freedom, and awakening)",
    governs: "innovation, freedom, rebellion, and awakening",
    personalImpact: "where you break free and express your uniqueness",
    whyItMatters: "Uranus brings sudden change and awakening - it shows where you need freedom and how you express your unique, revolutionary side.",
    lifeArea: "freedom and innovation"
  },
  neptune: {
    name: "Neptune",
    whatItIs: "Neptune (spirituality, dreams, and transcendence)",
    governs: "spirituality, dreams, intuition, and transcendence",
    personalImpact: "your connection to the spiritual and mystical",
    whyItMatters: "Neptune rules spirituality and dreams - it shows your connection to the divine and how you experience transcendence.",
    lifeArea: "spirituality and dreams"
  },
  pluto: {
    name: "Pluto",
    whatItIs: "Pluto (transformation, power, and rebirth)",
    governs: "transformation, power, death/rebirth, and regeneration",
    personalImpact: "where you experience deep transformation",
    whyItMatters: "Pluto rules transformation - it shows where you experience deep change and rebirth in your life.",
    lifeArea: "transformation and power"
  }
};

// Sign meanings in user-friendly language
const SIGN_MEANINGS_USER_FRIENDLY: Record<string, {
  name: string;
  energy: string;
  personalImpact: string;
}> = {
  Aries: { name: "Aries", energy: "pioneering, bold, independent", personalImpact: "you express yourself boldly and take initiative" },
  Taurus: { name: "Taurus", energy: "stable, grounded, sensual", personalImpact: "you express yourself steadily and value comfort and beauty" },
  Gemini: { name: "Gemini", energy: "curious, communicative, adaptable", personalImpact: "you express yourself through communication and curiosity" },
  Cancer: { name: "Cancer", energy: "nurturing, emotional, intuitive", personalImpact: "you express yourself through emotions and nurturing" },
  Leo: { name: "Leo", energy: "creative, confident, expressive", personalImpact: "you express yourself creatively and confidently" },
  Virgo: { name: "Virgo", energy: "analytical, practical, service-oriented", personalImpact: "you express yourself through practical service and analysis" },
  Libra: { name: "Libra", energy: "harmonious, diplomatic, relationship-focused", personalImpact: "you express yourself through balance and relationships" },
  Scorpio: { name: "Scorpio", energy: "intense, transformative, deep", personalImpact: "you express yourself with intensity and depth" },
  Sagittarius: { name: "Sagittarius", energy: "philosophical, adventurous, expansive", personalImpact: "you express yourself through exploration and philosophy" },
  Capricorn: { name: "Capricorn", energy: "disciplined, ambitious, structured", personalImpact: "you express yourself through discipline and achievement" },
  Aquarius: { name: "Aquarius", energy: "innovative, independent, humanitarian", personalImpact: "you express yourself through innovation and independence" },
  Pisces: { name: "Pisces", energy: "compassionate, intuitive, spiritual", personalImpact: "you express yourself through compassion and spirituality" }
};

// Function to get interpretation for planet in sign (ENHANCED with user-friendly explanations)
export function getPlanetSignInterpretation(planet: string, sign: string): EnhancedInterpretation {
  const baseInterpretation = PLANET_SIGN_INTERPRETATIONS[planet]?.[sign] || {
  ...
  // Get user-friendly meanings
  const planetInfo = PLANET_MEANINGS_USER_FRIENDLY[planet] || {
    name: planet,
    whatItIs: `${planet}`,
    governs: "this area of your life",
    personalImpact: "this part of you",
    whyItMatters: "This placement influences your life.",
    lifeArea: "this area"
  };
  
  const signInfo = SIGN_MEANINGS_USER_FRIENDLY[sign] || {
    name: sign,
    energy: "this sign's energy",
    personalImpact: "this sign's qualities"
  };
  
  // Build enhanced explanation
  const enhanced: EnhancedInterpretation = {
    ...baseInterpretation,
    
    whatThisIs: `${planetInfo.whatItIs} is placed in ${signInfo.name}, which means ${planetInfo.governs} expresses through ${signInfo.energy} energy.`,
    
    whatThisMeansForYou: `${baseInterpretation.description} Specifically, this means ${planetInfo.personalImpact} is colored by ${signInfo.personalImpact}. ${baseInterpretation.spiritualMeaning}`,
    
    howThisShowsUp: generateRealLifeExamples(planet, sign, baseInterpretation.keywords),
    
    whyThisMatters: `${planetInfo.whyItMatters} When combined with ${signInfo.name} energy, this creates ${baseInterpretation.keywords.join(' and ') || 'unique'} qualities in your ${planetInfo.lifeArea}.`,
    
    birthDataConnection: `Because ${planetInfo.name} was in ${signInfo.name} at the moment you were born, this ${planetInfo.name.toLowerCase()} style is part of your fundamental nature - it's how you're wired throughout your entire life.`
  };
  
  return enhanced;
}

// Helper function to generate real-life examples (simplified - can be expanded)
function generateRealLifeExamples(planet: string, sign: string, keywords: string[]): string[] {
  const planetInfo = PLANET_MEANINGS_USER_FRIENDLY[planet];
  const signInfo = SIGN_MEANINGS_USER_FRIENDLY[sign];
  
  if (!planetInfo || !signInfo) {
    return [`This placement affects your ${planetInfo?.lifeArea || 'life'} in unique ways.`];
  }
  
  // Generate examples based on planet and sign
  const examples: string[] = [];
  
  if (planet === 'moon' && sign === 'Sagittarius') {
    examples.push(
    ...
    // Generic examples based on keywords
    if (keywords.length > 0) {
      examples.push(`You might notice ${keywords[0].toLowerCase()} qualities showing up in your ${planetInfo.lifeArea}`);
      examples.push(`Your ${planetInfo.lifeArea} is naturally influenced by ${signInfo.energy}`);
      examples.push(`This placement shapes how you experience ${planetInfo.governs}`);
    } else {
      examples.push(`This placement influences your ${planetInfo.lifeArea} in meaningful ways`);
      examples.push(`You'll notice ${signInfo.energy} energy in your ${planetInfo.lifeArea}`);
    }
  }
...
// House meanings in user-friendly language
const HOUSE_MEANINGS_USER_FRIENDLY: Record<number, {
  name: string;
  lifeArea: string;
  plainExplanation: string;
  whatThisHouseRules: string;
}> = {
  1: { name: "1st House (House of Self)", lifeArea: "your identity and how others see you", plainExplanation: "This is the house of YOU - your personality, appearance, and how you present yourself to the world.", whatThisHouseRules: "who you are, how you appear to others, and your first impressions" },
  2: { name: "2nd House (House of Values)", lifeArea: "your money, possessions, and self-worth", plainExplanation: "This house rules your material resources - money, possessions, and how you value yourself.", whatThisHouseRules: "money, possessions, self-worth, and what you value" },
  3: { name: "3rd House (House of Communication)", lifeArea: "your communication, learning, and immediate environment", plainExplanation: "This house rules how you communicate, learn, and interact with your daily environment.", whatThisHouseRules: "communication, learning, thinking, and your immediate surroundings" },
  4: { name: "4th House (House of Home)", lifeArea: "your home, family, and emotional foundation", plainExplanation: "This house rules your home, family, and where you feel emotionally safe and secure.", whatThisHouseRules: "home, family, roots, and your emotional foundation" },
  5: { name: "5th House (House of Creativity)", lifeArea: "your creativity, romance, and self-expression", plainExplanation: "This house rules creativity, romance, children, and how you express yourself joyfully.", whatThisHouseRules: "creativity, romance, children, fun, and self-expression" },
  6: { name: "6th House (House of Service)", lifeArea: "your work, health, and daily routines", plainExplanation: "This house rules your daily work, health habits, and how you serve others.", whatThisHouseRules: "work, health, daily routines, and service to others" },
  7: { name: "7th House (House of Partnerships)", lifeArea: "your relationships and partnerships", plainExplanation: "This house rules your close relationships, partnerships, and how you relate to others.", whatThisHouseRules: "relationships, partnerships, marriage, and one-on-one connections" },
  8: { name: "8th House (House of Transformation)", lifeArea: "shared resources, transformation, and intimacy", plainExplanation: "This house rules deep transformation, shared resources, and intimate connections.", whatThisHouseRules: "transformation, shared resources, intimacy, and deep change" },
  9: { name: "9th House (House of Higher Learning)", lifeArea: "philosophy, higher education, and spirituality", plainExplanation: "This house rules your beliefs, higher learning, travel, and spiritual quests.", whatThisHouseRules: "philosophy, higher learning, travel, spirituality, and beliefs" },
  10: { name: "10th House (House of Career)", lifeArea: "your career, public image, and life direction", plainExplanation: "This house rules your career, public reputation, and your life's direction.", whatThisHouseRules: "career, public image, reputation, and life direction" },
  11: { name: "11th House (House of Friendships)", lifeArea: "your friends, groups, and hopes", plainExplanation: "This house rules your friendships, groups you belong to, and your hopes and dreams.", whatThisHouseRules: "friends, groups, hopes, dreams, and social connections" },
  12: { name: "12th House (House of the Subconscious)", lifeArea: "spirituality, the subconscious, and hidden things", plainExplanation: "This house rules your subconscious, spirituality, and things that are hidden or private.", whatThisHouseRules: "subconscious, spirituality, hidden things, and inner world" }
};

// Function to get house interpretation (ENHANCED with user-friendly explanations)
export function getHouseInterpretation(house: number) {
  const baseInterpretation = HOUSE_MEANINGS[house] || {
    title: `House ${house}`,
  ...
  const houseInfo = HOUSE_MEANINGS_USER_FRIENDLY[house] || {
    name: `House ${house}`,
    lifeArea: "this area of your life",
    plainExplanation: "This house influences your life.",
    whatThisHouseRules: "various life themes"
  };
  
  // Return enhanced interpretation with user-friendly explanation
  return {
    ...baseInterpretation,
    
    // NEW: User-friendly fields
    whatThisHouseIs: houseInfo.plainExplanation,
    whatThisHouseRules: `This house rules ${houseInfo.whatThisHouseRules}.`,
    whyThisMatters: `${houseInfo.plainExplanation} Planets placed in this house show how you experience ${houseInfo.lifeArea}.`,
    howThisAffectsYou: `When planets are in your ${houseInfo.name}, they influence ${houseInfo.lifeArea}. This shows where and how these planetary energies manifest in your daily life.`
  };
}
